...
| V1-05 | 🚧 發布候選版文件與已知限制 | V1-02..04 | RC、artifacts、Compose/Caddy/preflight、backup/restore scripts 已建立；ARM64、backend、localhost TLS/WSS、隔離 restore drill 通過。V1-01/03/04 真機、正式簽章/registry、公開 DNS/ACME、off-host backup/監控、Push/iOS 與最終 artifact 待完成 |
