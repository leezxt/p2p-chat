...
| V1-05 | 🚧 發布候選版文件與已知限制 | V1-02..04 | RC、artifacts、Compose/Caddy/preflight、backup/restore、bounded logs/monitor 已建立；localhost TLS/WSS 與 restore drill 通過。V1-01/03/04 真機、正式簽章/registry、公開 DNS/ACME、off-host backup/外部告警、Push/iOS 與最終 artifact 待完成 |
