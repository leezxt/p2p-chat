...
| V1-05 | 🚧 發布候選版文件與已知限制 | V1-02..04 | RC 建置/操作/驗收清單、Android fail-closed 簽章與 artifact/SHA-256 manifest 流程已建立；ARM64 internal profile 產物通過。V1-01/03/04 真機 Gate、正式憑證、release AAB、Push/iOS 實機與最終 artifact 待完成 |
