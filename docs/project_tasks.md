...
| V1-05 | 🚧 發布候選版文件與已知限制 | V1-02..04 | RC 清單、Android/backend artifact manifest 與 fail-closed gate 已建立；ARM64 profile、backend JAR/image、PostgreSQL production runtime 通過。V1-01/03/04 真機、正式簽章/registry digest、HTTPS/WSS、Push/iOS 與最終 artifact 待完成 |
